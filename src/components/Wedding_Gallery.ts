...
export default class WeddingGallery extends Vue {
  ...
  getImageUrl(className: string): string {
    const map: { [key: string]: string } = {
      ...
      img5: require("@/assets/img/JO__4221.jpg"),
      img6: require("@/assets/img/JO__4667.jpg"),
      img7: require("@/assets/img/JO__4942.jpg"),
      img8: require("@/assets/img/JO__5157.jpg"),
      img9: require("@/assets/img/img7.jpg"),
      img10: require("@/assets/img/JO__4313.jpg"),
      img11: require("@/assets/img/JO__4590.jpg"),
      img12: require("@/assets/img/1765766588439.jpg"),
      img13: require("@/assets/img/1765766588724.jpg"),
      img14: require("@/assets/img/1765766588882.jpg"),
      img15: require("@/assets/img/1765766589006.jpg"),
      img16: require("@/assets/img/1765766589094.jpg"),
      img17: require("@/assets/img/1765766589171.jpg"),
      img18: require("@/assets/img/1765766589276.jpg"),
      img19: require("@/assets/img/1765766589372.jpg"),
      img20: require("@/assets/img/1765766589446.jpg"),
      img21: require("@/assets/img/1765766589544.jpg"),
      img22: require("@/assets/img/1765766589677.jpg"),
      img23: require("@/assets/img/ya1.jpg"),
      img24: require("@/assets/img/ya2.jpg"),
      img25: require("@/assets/img/ya3.jpg"),
      img26: require("@/assets/img/ya4.jpg"),
      img27: require("@/assets/img/ya5.jpg"),
      img28: require("@/assets/img/ya6.jpg"),
      img29: require("@/assets/img/ya7.jpg"),
      img30: require("@/assets/img/ya8.jpg"),
      img31: require("@/assets/img/ya9.jpg"),
      img32: require("@/assets/img/ya10.jpg"),
      img33: require("@/assets/img/ya11.jpg"),
      img34: require("@/assets/img/ya12.jpg")
    };
